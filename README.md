...
```
cd existing_repo
git remote add origin https://gitlab.com/Randomguy01/Randomguy01.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Randomguy01/Randomguy01/-/settings/integrations)
